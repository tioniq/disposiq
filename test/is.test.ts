...
describe("is", () => {
  it("is disposable", () => {
    expect(isDisposable(new DisposableAction(() => {}))).toBe(true)
  ...
  it("is disposable like", () => {
    expect(isDisposableLike(new DisposableAction(() => {}))).toBe(true)
    ...
    expect(isDisposableLike(() => {})).toBe(true)
    expect(isDisposableLike(() => {})).toBe(true)
  ...
  it("is disposable compat", () => {
    expect(isDisposableCompat(new DisposableAction(() => {}))).toBe(true)
  ...
  it("is async disposable compat", () => {
    expect(isAsyncDisposableCompat(new DisposableAction(() => {}))).toBe(false)
    expect(
      isAsyncDisposableCompat(new AsyncDisposableAction(Promise.resolve)),
    ).toBe(true)
    expect(
      isAsyncDisposableCompat(new SafeAsyncActionDisposable(Promise.resolve)),
    ).toBe(true)
  ...
  it("is system disposable", () => {
    expect(isSystemDisposable(new DisposableAction(() => {}))).toBe(true)
  ...
  it("is system async disposable", () => {
    expect(isSystemAsyncDisposable(new DisposableAction(() => {}))).toBe(false)
    expect(
      isSystemAsyncDisposable(new AsyncDisposableAction(Promise.resolve)),
    ).toBe(true)
